<template>
	<view>
		...
		<!-- 选中的分类 -->
		<template v-if="post_class_index >= 0">
		<view class="font-md px-2 py-1 flex" :show="showCat">
			<view class="bg-main text-white border px-3 py main-color main-border-color flex align-center justify-center" style="border-radius: 50rpx;">
		...
		<!-- 多图上传 -->
		<upload-image show ref="uploadImage" :list="imageList" @change="changeImage"></upload-image>
		<!-- 底部操作条 -->
...
<script>
	const isOpenArray = ['所有人可见', '好友可见', '仅自己可见'];
